...
class lthnSDPSerializerSettings {
public:
    ...
    static lthnSDPSerializerSettings *getInstance(){
        if(instance == nullptr){
            instance = new lthnSDPSerializerSettings();
        }
        return instance;
    }

private:
    explicit lthnSDPSerializerSettings(){
        instance = this;
        customDateTimeFormat.isStringSet = false;
        customDateTimeFormat.isEnumSet = false;
    }
    static lthnSDPSerializerSettings *instance;
    CustomDateTimeFormat customDateTimeFormat;
};

lthnSDPSerializerSettings * lthnSDPSerializerSettings::instance = nullptr;
...
bool setDateTimeFormat(const QString &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        lthnSDPSerializerSettings::setDateTimeFormatString(dateTimeFormat);
    }
    return success;
}
...
bool setDateTimeFormat(const Qt::DateFormat &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        lthnSDPSerializerSettings::setDateTimeFormatEnum(dateTimeFormat);
    }
    return success;
}
...
QString toStringValue(const QDateTime &value) {
    if (lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return value.toString(lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
    }

    if (lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return value.toString(lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
    }
...
QString toStringValue(const lthnSDPObject &value) {
    return value.asJson();
}

QString toStringValue(const lthnSDPEnum &value) {
    return value.asJson();
}

QString toStringValue(const lthnSDPHttpFileElement &value) {
    return value.asJson();
}
...
QJsonValue toJsonValue(const QDateTime &value) {
    if (lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return QJsonValue(value.toString(lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString));
    }

    if (lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return QJsonValue(value.toString(lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum));
    }
...
QJsonValue toJsonValue(const lthnSDPObject &value) {
    return value.asJsonObject();
}

QJsonValue toJsonValue(const lthnSDPEnum &value) {
    return value.asJsonValue();
}

QJsonValue toJsonValue(const lthnSDPHttpFileElement &value) {
    return value.asJsonValue();
}
...
bool fromStringValue(const QString &inStr, QDateTime &value) {
    if (inStr.isEmpty()) {
       ...
       QDateTime dateTime;
        if (lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            dateTime = QDateTime::fromString(inStr, lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            dateTime = QDateTime::fromString(inStr, lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromStringValue(const QString &inStr, lthnSDPObject &value)
{
    QJsonParseError err;
...
bool fromStringValue(const QString &inStr, lthnSDPEnum &value) {
    value.fromJson(inStr);
    return true;
}

bool fromStringValue(const QString &inStr, lthnSDPHttpFileElement &value) {
...
bool fromJsonValue(QDateTime &value, const QJsonValue &jval) {
    ...
    if (!jval.isUndefined() && !jval.isNull() && jval.isString()) {
        if (lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            value = QDateTime::fromString(jval.toString(), lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            value = QDateTime::fromString(jval.toString(), lthnSDPSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromJsonValue(lthnSDPObject &value, const QJsonValue &jval) {
    bool ok = true;
    if (jval.isObject()) {
...
bool fromJsonValue(lthnSDPEnum &value, const QJsonValue &jval) {
    value.fromJsonValue(jval);
    return true;
}

bool fromJsonValue(lthnSDPHttpFileElement &value, const QJsonValue &jval) {
